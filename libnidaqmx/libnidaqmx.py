...
if os.name=='nt':
    ...
    libname = 'nicaiu'
    include_nidaqmx_h = r'C:\Program Files (x86)\National Instruments\NI-DAQ\DAQmx ANSI C Dev\include\NIDAQmx.h'
    lib = ctypes.util.find_library(libname)
    if lib is None:
        # try default installation path:
        lib = r'C:\Program Files (x86)\National Instruments\NI-DAQ\DAQmx ANSI C Dev\lib\nicaiu.dll'
...
class Task(uInt32):
    ...
    def configure_timing_sample_clock(self, 
        ...
        self.samples_per_channel = samples_per_channel
        self.sample_mode = sample_mode
        r = CALL('CfgSampClkTiming', self, source, float64(rate), active_edge_val, sample_mode_val, uInt64(samples_per_channel))
        return r==0
