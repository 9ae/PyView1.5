...
class CtrlPanel(wx.Panel):
    ...
    def __init__(self, parent, tl):
        ...
        self.input_expDur = wx.TextCtrl(self, id=299, value=str(X.trialDuration), size=(50, -1))
        ...
        ss.Add(wx.StaticText(self, -1, "ADD COMPONENTS"), flag=wx.ALIGN_CENTER_HORIZONTAL, row=1, col=3, colspan=2)
        ss.AddSpacer(800, 20, row=2, col=1, colspan=4)
        ss.AddSpacer(400, 20, row=3, col=1, colspan=2, rowspan=5)
...
class DialogTaste(ActionForm):
    ...
    def __init__(self, parent, ID):
        ...
        self.rtField = wx.TextCtrl(self,-1,value=str(0.043))
